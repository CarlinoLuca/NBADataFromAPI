...
class dataScraperInfo :ObservableObject{
    
    
    //occhio al link dell'immagine, di mettere il nome +jpg
    @Published var allPlayerData :playerDataScraper = playerDataScraper(nomeGiocatore: "", nomeCompleto: "", linkImmagine: "https://www.basketball-reference.com/req/202106291/images/players/")
    ...
    init(nomeGiocatore: String, cognomeGiocatore: String){
        ...
        allPlayerData.linkImmagine = allPlayerData.linkImmagine + createReduceName(nomeGiocatore: nomeGiocatore, cognomeGiocatore: nomeGiocatore)
        
        print(self.allPlayerData.linkImmagine)
    ...
    func createReduceName(nomeGiocatore: String, cognomeGiocatore: String) -> String {
        ...
        return FiveLetterOfSurname.lowercased() + ThreeLetterOfName.lowercased() + ".jpg"
    }
